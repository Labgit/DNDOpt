...
def test(test_list):
        ...
        combo.focus_set()
        checkVar = tk.IntVar()
        check = tk.Checkbutton(root, text='test check', variable=checkVar)
        check.grid()
        button = tk.Button(root, text='test', command= lambda: testthing(check))
        button.grid()
...
def testthing(thing):
    print thing.cget('text')
    print thing.cget('variable')
